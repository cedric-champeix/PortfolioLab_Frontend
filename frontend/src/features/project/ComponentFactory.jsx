...
export default function ComponentFactory({component, update, remove}) {
    ...
    const renderComponent = () => {
        switch (component.type) {
            ...
            case "TEXT_IMAGE":
                return <TextImageComponent component={component} update={update} leftText={true}/>
            case "IMAGE_TEXT":
                return <TextImageComponent component={component} update={update} leftText={false}/>
            default:
                return <Grid container padding="20px 20px" spacing={2}>
                    <Typography variant={"body1"} color="primary">Reload...</Typography>
                </Grid>
        }
    }
