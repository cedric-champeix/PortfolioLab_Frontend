...
import { SkillChipViewer } from '../../features/skills/components/SkillChipViewer.tsx';
import { useViewerProject } from '../../features/viewer/portfolio/hooks/useViewerProject.ts';
import { ViewerComponentFactory } from '../../features/viewer/portfolio/ViewerComponentFactory.tsx';
import NotFoundPage from '../error/404.tsx';

interface Props {}

export const ViewerProject: React.FunctionComponent<Props> & {
  ...
  if (projectError) return <NotFoundPage />;
